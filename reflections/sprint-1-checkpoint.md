...
medulla search "logD outliers Salacia NDI"
...
**What happened:** `medulla search "NDI-218229 batch effect"` returned no results. The detailed analysis — "NDI-218229 has Δ = +6.11, 4σ above batch mean, almost certainly a measurement error" — was in *Claude's response*, not in the user's message. The user said things like "look at that Salacia outlier", which doesn't contain "NDI-218229".
