...
Page format inherited from LLMWiki / Karpathy LLM Wiki pattern.
...
# Tag vocabulary — reuse these before inventing new ones (same philosophy as LLMWiki)
TAG_VOCABULARY = [
...
def update_index(wiki_path: Path, slug: str, page_type: str, title: str, summary_line: str) -> None:
    """Update index.md with LLMWiki format: [[folder/slug|slug]] in tables + stats header."""
